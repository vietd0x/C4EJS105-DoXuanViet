...
let {jobTitle} = jobData.hits[0];
console.log(jobTitle);

console.log("___________15.4_________");
let {benefits} = jobData.hits[0];
console.log(benefits);

console.log("___________15.5_________");
console.log("First job hit benefit:");
let {benefits:[{benefitValue: bv1}, {benefitValue: bv2}, {benefitValue: bv3}]} = jobData.hits[0];
console.log(`- ${bv1}\n- ${bv2}\n- ${bv3}`);
