...
// for(let property_ in product)
//     console.log(`${property_}: ${product[property_]}`);
...
//     dueData: '2019-10-08T18:00:24+00',
//     expectedHours: 0.5,
// };
// let {subject, dueData, assignTo} = task;
// console.log(subject);
// console.log(dueData);
// console.log(assignTo);
//____________________________3_______________________________
const jobSearch = 
{
    hits: [
        {
...
console.log("__________3.1__________");
console.log("This is an object");
console.log("__________3.2__________");
console.log("This is an array");
console.log("__________3.3__________");
for(let i in jobSearch.hits)
{
    let {jobTitle, locations, jobSalary, benefits:[{benefitValue: bv1}, {benefitValue: bv2}, {benefitValue: bv3}], skills, jobRequirement }= jobSearch.hits[i];
